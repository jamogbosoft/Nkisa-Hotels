<%@ Page Title="Room Features" Language="C#" MasterPageFile="~/SiteAdmin.master" AutoEventWireup="true" CodeFile="RoomFeatures.aspx.cs" Inherits="RoomFeatures" EnableSessionState="True" %>
...
<!--        ddd                  -->
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    ...
                    <tr class="callOutStyle" valign="top">
                        <td class="style40" align="center" valign="top" colspan="2">Room Features</td>
                    </tr>
	...
	<tr style="height:100%;" valign="top">
        ...
        <tr valign="top">
			<td align="right">
                <asp:Label ID="Label2" runat="server" Text="Room Feature:" Font-Bold="True"></asp:Label>
            </td>
            <td align="left">
                <asp:DropDownList
                    ID="cboRoomFeature" runat="server">
                </asp:DropDownList>
             </td>
             <td align="left">
    ...
    <AlternatingRowStyle BackColor="PaleGoldenrod" HorizontalAlign="Center" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="RoomFeatureID" FooterText="Room Feature ID" 
                HeaderText="Room Feature ID">
            ...
            <asp:BoundField DataField="RoomFeatureName" FooterText="Room Feature" 
                HeaderText="Room Feature">
