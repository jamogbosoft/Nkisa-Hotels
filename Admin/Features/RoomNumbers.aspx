<%@ Page Title="Room Numbers" Language="C#" MasterPageFile="~/SiteAdmin.master" AutoEventWireup="true" CodeFile="RoomNumbers.aspx.cs" Inherits="RoomNumbers" EnableSessionState="True" %>
...
<asp:UpdateProgress ID="UpdateProgress2" runat="server" 
   ...
   <table cellspacing="0" height="100%" cellpadding="4" rules="all"
    ...
    <tr class="callOutStyle">
        <td  align="center" colspan="2">Add/Update Rooms</td>
    </tr>
    <tr>
				<td valign="top">
                    ...
                    <tr>
						<td height="30px" >Room Number:</td>
                                                
                         <td  >                         
                             <asp:TextBox ID="txtRoomNumber" runat="server" MaxLength="25" Width="300px" 
                                 ValidationGroup="Group1"></asp:TextBox>

                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorRoomNumber" 
	                            runat="server" ControlToValidate="txtRoomNumber" 
	                            ErrorMessage="Room Number cannot be empty." ForeColor="Red" 
	                            SetFocusOnError="True" ValidationGroup="Group1">*</asp:RequiredFieldValidator>

                             <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtenderRoomNumber"
	                            TargetControlID="RequiredFieldValidatorRoomNumber"
       ...
       <table cellspacing="0" height="100%" cellpadding="4" rules="all"
            ...
            <tr class="bodyText"  height="100%" valign="top" align="center">
                <td style="padding-left:10;padding-right:10;" align="center" valign="top">  
                                ...
                                <asp:GridView ID="GridViewRoomNumbers" runat="server" AllowPaging="True" 
                                    CaptionAlign="Top" CellPadding="3" GridLines="None" 
                                ShowHeaderWhenEmpty="True" Font-Names="Times New Roman" Font-Size="Small" 
                                    onpageindexchanging="GridViewRoomNumbers_PageIndexChanging" 
                                    onselectedindexchanged="GridViewRoomNumbers_SelectedIndexChanged" 
                                ...
                                <AlternatingRowStyle HorizontalAlign="Center" 
                                    ...
                                    <Columns>
                                       <asp:TemplateField ShowHeader="False">
                                        ...
                                        <asp:BoundField DataField="RoomID" FooterText="RoomID" 
                                            HeaderText="RoomID" />
