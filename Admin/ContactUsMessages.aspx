<%@ Page Title="Contact Us Messages" Language="C#" MasterPageFile="~/SiteAdminMessages.master" AutoEventWireup="true" CodeFile="ContactUsMessages.aspx.cs" Inherits="ContactUsMessages" EnableSessionState="True" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="AdminMainContent" Runat="Server">  
    ...
    <h1 >
        <span style="font-family: 'Agency FB'; font-size: xx-large; font-weight: bold; font-style: normal; font-variant: normal; color: #008080; text-align: left">Contact Us Messages</span>
                ...
                <table cellspacing="0" height="100%" cellpadding="4" rules="all"
                    ...
                    <tr class="bodyText"  height="100%" valign="top" align="center">
                        <td style="padding-left:10;padding-right:10;" align="center" valign="top">                               
                                ...
                                <asp:GridView ID="GridViewContactUsMessages" runat="server" AllowPaging="True"
                                ...
                                ShowHeaderWhenEmpty="True" Font-Names="Times New Roman" Font-Size="Small"
                                    ...
                                    BorderWidth="1px" 
                                    onpageindexchanging="GridViewContactUsMessages_PageIndexChanging" 
                                    AutoGenerateColumns="False" 
                                    PageSize="25" 
                                    onselectedindexchanged="GridViewContactUsMessages_SelectedIndexChanged" 
                                    BorderStyle="None" >
                                <AlternatingRowStyle BackColor="#F7F7F7" HorizontalAlign="Left" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Message" FooterText="Message" HeaderText="Message" >
