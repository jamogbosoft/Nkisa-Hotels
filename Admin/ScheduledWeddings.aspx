<%@ Page Title="Scheduled Weddings" Language="C#" MasterPageFile="~/SiteAdminMessages.master" AutoEventWireup="true" CodeFile="ScheduledWeddings.aspx.cs" Inherits="ScheduledWeddings" EnableSessionState="True" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="AdminMainContent" Runat="Server">  
    ...
    <h1 >
        <span style="font-family: 'Agency FB'; font-size: xx-large; font-weight: bold; font-style: normal; font-variant: normal; color: #008080; text-align: left">Scheduled Weddings</span>
                ...
                <table cellspacing="0" height="100%" cellpadding="4" rules="all"
                    ...
                    <tr class="bodyText"  height="100%" valign="top" align="center">
                        <td style="padding-left:10;padding-right:10;" align="center" valign="top">                               
                                ...
                                <asp:GridView ID="GridViewScheduledWeddings" runat="server" AllowPaging="True"
                                ...
                                ShowHeaderWhenEmpty="True" Font-Names="Times New Roman" Font-Size="Small"
                                    ...
                                    BorderWidth="1px" 
                                    onpageindexchanging="GridViewScheduledWeddings_PageIndexChanging" 
                                    AutoGenerateColumns="False" 
                                    PageSize="25" 
                                    onselectedindexchanged="GridViewScheduledWeddings_SelectedIndexChanged" 
                                    BorderStyle="None" >
                                <AlternatingRowStyle BackColor="#F7F7F7" HorizontalAlign="Left" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="WeddingID" >
                                        ...
                                        <asp:BoundField DataField="WeddingHallCapacity" FooterText="Wedd Hall Capacity" 
                                            HeaderText="Wedd Hall Capacity" >
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="ReceptionHallCapacity" 
                                            FooterText="Recpt Hall Capacity" HeaderText="Recpt Hall Capacity" >
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                ...
                                <SelectedRowStyle BackColor="#738A9C" ForeColor="#F7F7F7" 
                                        HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="True" />
